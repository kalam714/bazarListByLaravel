            ...
            <div class="card">
                ...
                {!!Form::open(['action' => ['App\Http\Controllers\ListingController@update',$listing->id],'method'=>'POST'])!!}
                   ...
                   {{Form::label('', 'Items Name',['for'=>'cname'])}}
                     {{Form::text('items',$listing->items,['class'=>'form-control'])}}
                   </div>
                   <div class="form-group">
                   {{Form::label('', 'Amount',['for'=>'cname'])}}
                     {{Form::text('amount',$listing->amount,['class'=>'form-control'])}} 
                   </div>
                   <div class="form-group">

                   {{Form::label('', 'Estimate Cost',['for'=>'cname'])}}
                    {{Form::number('estimated_cost',$listing->estimated_cost,['class'=>'form-control'])}}
